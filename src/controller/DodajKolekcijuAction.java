...
public class DodajKolekcijuAction extends AbstractAction{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(!((childNodeView.getUserObject() instanceof RadniProstor) || (childNodeView.getUserObject() instanceof Kolekcija))) {
			...
			//JOptionPane.showMessageDialog(null, "Mozete dodati samo novu kolekciju.");
			return;
			//Ako nije ni kolekcija ni radni prostor nemoj nista raditi (inace bi bio exception)
			//Ovde bi se moglo ubaciti neko obavestenje o gresci
